...
app.constant('ASSETS', {
  ...
  'icons': {
    'meteocons': appHelper.assetPath(
      'css/fonts/meteocons/css/meteocons.css'),
  ...
  'forms': {
    ...
    'selectboxit': appHelper.assetPath(
      'js/selectboxit/jquery.selectBoxIt.js'),

    'tagsinput': appHelper.assetPath(
      'js/tagsinput/bootstrap-tagsinput.min.js'),

    'datepicker': appHelper.assetPath(
      'js/datepicker/bootstrap-datepicker.js'),

    'timepicker': appHelper.assetPath(
      'js/timepicker/bootstrap-timepicker.min.js'),

    'inputmask': appHelper.assetPath(
  ...
  'uikit': {
    ...
    'htmleditor': appHelper.assetPath(
      'js/uikit/js/addons/htmleditor.min.js'),
